...
def mosaic_with_gdal_python(tile1_path, tile2_path, output_path, aoi_shapefile=None):
    ...
    # Method 1: Use VRT for reliable mosaicking
    print("\n=== METHOD 1: Creating VRT mosaic ===")
    ...
    try:
        ...
        vrt_options = gdal.BuildVRTOptions(
            ...
            resampleAlg='nearest',  # Use nearest neighbor resampling
            srcNodata=0,
            VRTNodata=0
        )
    ...
    if aoi_shapefile and os.path.exists(aoi_shapefile):
        print(f"\n=== Clipping with AOI: {aoi_shapefile} ===")
        ...
        try:
            ...
            if clipped_ds is None:
                ...
                print(f"✓ Replaced original with clipped version")
    ...
    if os.path.exists(output_path):
        ...
        print(f" SUCCESS! Mosaic completed")
